...
// super("Клиент");
        setTitle("КЛИЕНТ");
        tf = new TextField("127.0.0.1");//ip address клиента
        ...
        la1 = new Label("порт");
        la2 = new Label("");
        la3 = new Label("Результат, полученный от сервера");
        la5 = new Label("Посылаемые данные ");
        la4 = new Label("");
        ...
        tf1.setBounds(370, 50, 70, 25);
        tf2.setBounds(150, 200, 90, 25);
        tf3.setBounds(250, 200, 90, 25);
        ta.setBounds(150, 300, 300, 200);
        btn.setBounds(50, 50, 70, 25);
        btn1.setBounds(50, 200, 70, 25);
        la.setBounds(130, 50, 180, 25);
        la1.setBounds(320, 50, 150, 25);
        la2.setBounds(150, 150, 150, 25);
        la3.setBounds(160, 250, 200, 25);
        la5.setBounds(150, 170, 150, 25);
...
tf2.setEnabled(false);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            os.flush();// отправляем введенные данные. Тип string переводим в byt
